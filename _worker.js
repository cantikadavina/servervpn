...
// Variables
const rootDomain = "cantikadavina234.workers.dev"; // Ganti dengan domain utama kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Cantika VPN</span>");
